...
One product I'm about to create will be a tool made to enable teachers to extremely easily create chatbots customized to the class curriculum. These chatbots would be capable of answering complex questions about any material provided by the teacher, while citing its sources from within the material so that students learn from the answers it provides. It would also have additional features for teachers such as allowing them to monitor their student's usage, and additional features for students such as curating passages from the material to review. I plan to eventually create a suite of AI-powered tools to enable teachers to easily engage their students and increase their comprehension of the educational content. I intend for this to serve as one of the many stepping stones on the path to AI-driven education.
